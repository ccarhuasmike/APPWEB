...
namespace Utilitarios.Converters
{
    public class DataUtil
    {
        ...
        public static string ObjectToDateTimeStringNullGeneral(object obj)
        {
            ...
            {
                if (DataUtil.ObjectToDateTime(obj).ToShortDateString().Substring(0, 10) == "01/01/1900")
                    return "";
                else
                    return DataUtil.ObjectToDateTime(obj).ToString("yyyyMMdd");
            }
        }
        #region TryParse
        public static DateTime StringObjectToDateTime(string obj)
        {
            ...
            if (obj == null)
                ...
                try { Temp = DataUtil.ObjectToDateTime(obj); }
        ...
        public static int ObjectToIntTryParse(object obj)
        {
            ...
            if (obj == null)
                ...
                try { Temp = DataUtil.ObjectToInt32(obj); }
        ...
        public static DateTime DateMorTime(DateTime obj, DateTime oTime)
        {
            try
            {
                ...
                {
                    obj = (DataUtil.ObjectToDateTime(obj.ToShortDateString())).Add(oNewTime);
                }
                return obj;
            }
            catch
